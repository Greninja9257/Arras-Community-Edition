const MazeZone = class {
  ...
  blocks () {
    ...
    for (let x = 0; x < this.width; x++) {
      for (let y = 0; y < this.height; y++) {
        if (this.array[x][y]) { blocks.push({ x: x + this.offset.x, y: y + this.offset.y, size: 1 }) }
      }
    }
    return blocks
  }
  ...
  shaveSingles () {
    ...
    if (this.length <= 3) { return [null, this.blocks()] }
    /* if (this.length === 4)
        if (width === 2 && height === 2)
    ...
    if (shaved) { return [this.normalize(), output] }
    return null
  }
  ...
  takeBiggestSquare () {
        ...
        loop: while (x + size < width && y + size < height) {
          for (let i = 0; i <= size; i++) {
            if (!this.array[x + size][y + i] ||
               !this.array[x + i][y + size]) { break loop }
          }
          size++
        }
        if (size > maxSize) {
    ...
    if (best.x === 0 || best.x + maxSize === width ||
       best.y === 0 || best.y + maxSize === height) { this.normalize() }
    return square
  }
...
const MazeGenerator = class {
  ...
  erodeSym4 (side, corner) {
    if (this.width !== this.height) { throw new Error('Maze must be a square') }
  ...
  runNormal () {
    this.clear(`
        ...
        --------------------------------
      `)
    for (let i = 0; i < 75; i++) { this.erode(0, 1) } // Shaves outer rim
    for (let i = 0; i < 200; i++) {
      this.erode(1, 2)
      this.erode(2, 2)
    }
  ...
  run2Teams () {
    this.clear(`
        ...
        --------------------------------
      `)
    for (let i = 0; i < 5; i++) { this.erodeSym2(0, 2) }
    for (let i = 0; i < 5; i++) {
      this.erodeSym2(0, 2)
      this.erodeSym2(2, 2)
      this.erodeSym2(2, 2)
    ...
    for (let i = 0; i < 75; i++) { this.erodeSym2(1, 2) }
    for (let i = 0; i < 5; i++) {
      this.erodeSym2(0, 2)
      this.erodeSym2(2, 2)
      this.erodeSym2(2, 2)
    ...
    for (let i = 0; i < 25; i++) { this.erodeSym2(0, 0) }
  }
  ...
  run4Teams () {
    this.clear(`
        ...
        --------------------------------
      `)
    for (let i = 0; i < 5; i++) { this.erodeSym4(0, 2) }
    for (let i = 0; i < 2; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 40; i++) { this.erodeSym4(1, 2) }
    for (let i = 0; i < 2; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 12; i++) { this.erodeSym4(0, 0) }
  }
  ...
  run8Teams () {
    this.clear(`
        ...
        --------------------------------
      `)
    for (let i = 0; i < 4; i++) { this.erodeSym4(0, 2) }
    for (let i = 0; i < 2; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 25; i++) { this.erodeSym4(1, 2) }
    for (let i = 0; i < 2; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 6; i++) { this.erodeSym4(0, 0) }
  }
  ...
  run8TeamsLabyrinth () {
    this.clear(`
        ...
        --------------------------------------------------------------------------------------------------------------------------------
      `)
    for (let i = 0; i < 32; i++) { this.erodeSym4(0, 2) }
    for (let i = 0; i < 32; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 500; i++) { this.erodeSym4(1, 2) }
    for (let i = 0; i < 32; i++) {
      this.erodeSym4(0, 2)
      this.erodeSym4(2, 2)
      this.erodeSym4(2, 2)
    ...
    for (let i = 0; i < 96; i++) { this.erodeSym4(0, 0) }
  }
  ...
  runBunker () {
    this.clear(`
        ...
        --------------------------------
      `)
    for (let i = 0; i < 8; i++) { this.erode(0, 2) }
    for (let i = 0; i < 5; i++) {
      this.erode(0, 2)
      this.erode(2, 2)
      this.erode(2, 2)
    ...
    for (let i = 0; i < 40; i++) { this.erode(1, 2) }
    for (let i = 0; i < 5; i++) {
      this.erode(0, 2)
      this.erode(2, 2)
      this.erode(2, 2)
    ...
    for (let i = 0; i < 15; i++) { this.erode(0, 0) }
  }
  ...
  runBooster () {
    this.clear(`
          ...
          ---------------------------------------------------
        `)
    for (let i = 0; i < 20; i++) { this.erode(null, null) }
    for (let i = 0; i < 8; i++) { this.erode(0, 2) }
    for (let i = 0; i < 5; i++) {
      this.erode(0, 2)
      this.erode(2, 2)
  ...
  runTrenches () {
    this.clear(`
        ...
        ----------####################
        `)
    for (let i = 0; i < 25; i++) { this.erode(null, null) }
  }
  ...
  runEye () {
    this.clear(`
          ...
          ------------------------------
        `)
    for (let i = 0; i < 35; i++) { this.erode(null, null) }
  }
  ...
  runYinYang () {
    this.clear(`
          ...
          --------------------------------
        `)
    for (let i = 0; i < 8; i++) { this.erodeSym2(0, 2) }
    this.erodeSym2(1, 2)
    for (let i = 0; i < 6; i++) { this.erodeSym2(null) }
    for (let i = 0; i < 4; i++) { this.erodeSym2(1, 2) }
  }
  ...
  runBlitz () {
    this.clear(`
          ...
          --------------------------------
        `)
    for (let i = 0; i < 100; i++) { this.erode(null, null) }
  }
  ...
  runCitadel () {
    this.clear(`
          ...
          --------------------------
        `)
    for (let i = 0; i < 15; i++) { this.erode(null, null) }
  }
  ...
  runFortress () {
    this.clear(`
        ...
        ----------------------------
      `)
    for (let i = 0; i < 45; i++) { this.erode(null, null) }
  }
  ...
  runMothership () {
    this.clear(`
        ...
        ----------------------------------
      `)
    for (let i = 0; i < 5; i++) { this.erode(null, null) }
  }
