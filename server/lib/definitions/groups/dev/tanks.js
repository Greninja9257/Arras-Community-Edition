...
// Compatibility aliases for legacy fun-menu entries that may be missing in merged definition sets.
if (!Class.alas) Class.alas = { PARENT: "basic", LABEL: "Alas" };
if (!Class.heptaAutoBasic) Class.heptaAutoBasic = { PARENT: "basic", LABEL: "Hepta Auto Basic" };
if (!Class.protector) Class.protector = { PARENT: "basic", LABEL: "Protector" };
if (!Class.smasher3) Class.smasher3 = { PARENT: "smasher", LABEL: "Smasher-3" };
if (!Class.meOnMyWayToDoYourMom && Class.momwtdym) Class.meOnMyWayToDoYourMom = { PARENT: "momwtdym", LABEL: "Me on my way to do your mom" };
