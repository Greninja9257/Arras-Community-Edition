  ...
  for (const block of message) {
    ...
    if (typeCode === lastTypeCode) {
      ...
      if (repeatTypeCount >= 1) {
        ...
        if (repeatTypeCount === 1) { headerCodes.push(lastTypeCode) } else if (repeatTypeCount === 2) { headerCodes.push(0b1100) } else if (repeatTypeCount === 3) { headerCodes.push(0b1101) } else if (repeatTypeCount < 20) {
          headerCodes.push(0b1110)
