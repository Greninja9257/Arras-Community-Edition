class gameHandler {
    ...
    maintainloop = () => {   
        ...
        // Spawn bosses
        if (this.checkUsers() && (Config.enable_bosses ?? Config.bosses_spawn) && !this.naturallySpawnedBosses.length && this.bossTimer++ > Config.boss_spawn_cooldown) {
