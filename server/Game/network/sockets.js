...
class socketManager {
  ...
  update (gui) {
    ...
    if (Config.daily_tank) {
      ...
      gui.dailyTank.update(JSON.stringify([dailyTank, !!(Config.daily_tank.ads.enabled && !b.socket.status.daily_tank_watched_ad)]))
    }
      ...
      gazeUpon: (updateCam = false) => {
        ...
        if (player.body != null) {
          ...
          if (player.body.isDead()) {
            ...
            const y = player.body.cameraOverrideY === null ? player.body.photo.y : player.body.cameraOverrideY
